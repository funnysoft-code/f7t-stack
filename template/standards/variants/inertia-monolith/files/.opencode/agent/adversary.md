...
If the diff changes a screen, require `design/mocks/<slug>/{index.html,mock.png,mock-mobile.png,route.png,route-mobile.png}` and a compare at both viewports. Missing files are Critical.
