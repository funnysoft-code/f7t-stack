---
name: design-mock
description: Create or change a screen mock. Search Mobbin first. Writes packages/design-system/mocks/<slug>/index.html, mock.png, and mock-mobile.png. Stops there. Do not use when writing app code.
---
...
```
packages/design-system/mocks/<slug>/
  index.html
  mock.png
  mock-mobile.png
```
...
1. Read `packages/design-system/DESIGN.md` and `tokens.css`.
...
```
./scripts/screenshot.sh packages/design-system/mocks/<slug>/index.html packages/design-system/mocks/<slug>/mock.png
./scripts/screenshot.sh packages/design-system/mocks/<slug>/index.html packages/design-system/mocks/<slug>/mock-mobile.png 390x844
```
