---
name: frontend-ui
description: Implement a screen after a mock exists. Requires packages/design-system/mocks/<slug>/index.html, mock.png, and mock-mobile.png. Ends at route.png and route-mobile.png compared to the mocks.
---
...
Refuse to start if `packages/design-system/mocks/<slug>/index.html`, `mock.png`, or `mock-mobile.png` is missing. Tell the caller to run `design-mock` first.

Read the mock HTML and `packages/design-system/DESIGN.md`.
...
```
./scripts/screenshot.sh <real-route-url> packages/design-system/mocks/<slug>/route.png
./scripts/screenshot.sh <real-route-url> packages/design-system/mocks/<slug>/route-mobile.png 390x844
```
