...
`design/DESIGN.md` is the design source of truth. Tokens live beside it.

A new or changed screen is not implemented until `design/mocks/<slug>/index.html`, `mock.png`, and `mock-mobile.png` exist.
