---
name: design-mock
description: Create or change a screen mock. Search Mobbin first. Writes design/mocks/<slug>/index.html, mock.png, and mock-mobile.png. Stops there. Do not use when writing app code.
---
...
1. Read `design/DESIGN.md` and `tokens.css`.
...
```
./scripts/screenshot.sh design/mocks/<slug>/index.html design/mocks/<slug>/mock.png
./scripts/screenshot.sh design/mocks/<slug>/index.html design/mocks/<slug>/mock-mobile.png 390x844
```
